<?php
    ...
    $res=pg_query($con,"Select * from product where pcategory='Snacks'");
    if(!$res)
    {
        echo "UNABLE";
    }
    ...
    $price=$row['price'];
?>
<form action="sn.php" method="POST">
    <div class="gallery">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        ...
                        <div class="desc"><?php echo $prname;?><br><?php echo "Rs ".$price;?><br>
                            <button class="button" name="snacks" value= "<?php echo $prid;?>">Add To Cart</button>
                        </div>
                    </div>
                </div>
            </a>
